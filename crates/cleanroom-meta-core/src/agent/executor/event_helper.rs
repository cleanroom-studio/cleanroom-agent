use cleanroom_meta_llm::chat::StreamChunk as LlmStreamChunk;
use cleanroom_meta_protocol::StreamChunk;
...
mod tests {
    use super::*;
    use cleanroom_meta_llm::chat::StreamChunk as LlmStreamChunk;
    use cleanroom_meta_protocol::StreamChunk as ProtocolStreamChunk;
