...
mod tests {
    ...
    async fn test_store_user_enabled() {
        ...
        let task = MetaTask::new("user message");
...
impl MemoryAdapter {
    ...
    pub async fn recall_messages(&self, task: &MetaTask) -> Vec<MetaMessage> {
    ...
    pub async fn store_user(&self, task: &MetaTask) {
