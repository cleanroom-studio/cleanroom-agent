...
pub trait MetaOutputT: Serialize + DeserializeOwned + Send + Sync {
...
/// Implementation of MetaOutputT for String type (when no output is specified)
impl MetaOutputT for String {
    fn output_schema() -> &'static str {
        "{}"
    }
...
mod tests {
    ...
    impl MetaOutputT for TestOutput {
        fn output_schema() -> &'static str {
    ...
    impl MetaOutputT for SimpleOutput {
        fn output_schema() -> &'static str {
    ...
    impl MetaOutputT for ComplexOutput {
        fn output_schema() -> &'static str {
    ...
    fn test_agent_output_trait_basic() {
        ...
        fn assert_agent_output<T: MetaOutputT>() {}
